...
.section {
    height: 400px; /* Hauteur fixe pour chaque section */
    display: flex;
    align-items: center;
}
...
.paragraphe {
    line-height: 1.7;
    margin-bottom: 20px;
    padding: 0 9.2em; /* Ajustement du padding pour le contenu de la section */
}
...
/* Styles pour la section des chiffres */
.chiffres {
...
.carousel-control-next-icon::before {
  ...
  mask: url('data:image/svg+xml;charset=UTF-8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path fill="white" d="M11.354 1.646a.5.5 0 0 1 0 .708L6.707 7l4.647 4.646a.5.5 0 0 1-.708.708l-5-5a.5.5 0 0 1 0-.708l5-5a.5.5 0 0 1 .708 0z"/></svg>') center / contain no-repeat;
}

.carousel-control-next-icon::before {
  mask: url('data:image/svg+xml;charset=UTF-8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16"><path fill="white" d="M4.646 1.646a.5.5 0 0 0 0 .708L9.293 7 4.646 11.646a.5.5 0 0 0 .708.708l5-5a.5.5 0 0 0 0-.708l-5-5a.5.5 0 0 0-.708 0z"/></svg>') center / contain no-repeat;
}
